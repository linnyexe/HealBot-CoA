...
local HealBot_Buff_Spells_Total_List = {
    ...
    -- CoA Custom Classes (no known buffs)
    ["PYRO"] = {},
    ["NECR"] = {},
    ["TINK"] = {},
    ["SPIR"] = {},
...
function HealBot_Options_InitBuffClassList()
    ...
    if not HealBot_Buff_Spells_Class_List then
...
function HealBot_Options_Class_HoTctlAction_Refresh(onselect)
    ...
    if HealBot_Globals.WatchHoT[hbClass] and HealBot_Globals.WatchHoT[hbClass][HealBot_Globals.HoTname] then
...
function HealBot_Options_Class_HoTctlAction_OnSelect(self)
    local hbClass=strsub(HealBot_PlayerClassEN,1,4)
    if not HealBot_Globals.WatchHoT[hbClass] then
        HealBot_Globals.WatchHoT[hbClass] = {}
    end
