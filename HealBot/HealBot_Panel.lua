...
local HealBot_ClassIconCoord = {
    ...
    DEFAULT = {4,4},
    -- CoA Custom Classes
    PYROMANCER = {4,4}, NECROMANCER = {4,4}, TINKER = {4,4},
    SPIRITMAGE = {4,4}, STARCALLER = {4,4}, WITCHHUNTER = {4,4},
    PROPHET = {4,4}, REAPER = {4,4}, FLESHWARDEN = {4,4},
    DEMONHUNTER = {4,4}, SUNCLERIC = {4,4}, GUARDIAN = {4,4},
    SONOFARUGAL = {4,4}, WINDWALKER = {4,4}, CHRONOMANCER = {4,4},
    MONK = {4,4}, RANGER = {4,4}, BARBARIAN = {4,4},
    STORMBRINGER = {4,4}, WITCHDOCTOR = {4,4}, CULTIST = {4,4},
};
